...
var (
	...
	TmplBrowser = "imagesbrowser.html"
)

var (
	templateNames = []string{TmplForum, TmplTopic, TmplTopic1, TmplPosts, TmplNewPost, TmplLogs, TmplFooter, TmplHelp, TmplBrowser, "header.html", "post1.html"}
